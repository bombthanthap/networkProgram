...
VarDrinkList = [VarLattae,VarEspresso,VarIceLattae,VarValeCoffee,
               VarCappuccino,VarAfricanCoffee,VarAmericanCoffee,VarIcedCappuccino]
...
EntryDrinkList = [E_Lattae,E_Espresso,E_IceLattae,E_ValeCoffee,
                 E_Cappuccino,E_AfricanCoffee,E_AmericanCoffee,E_IcedCappuccino]
...
Lattae = Checkbutton(fCoffee, text="Lattae \t",variable = VarLattae,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarLattae,txtLattae,E_Lattae)).grid(row= 0, sticky=W)
Espresso = Checkbutton(fCoffee, text="Espresso \t",variable = VarEspresso,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarEspresso,txtEspresso,E_Espresso)).grid(row= 1, sticky=W)
IceLattae = Checkbutton(fCoffee, text="Ice Lattae \t",variable = VarIceLattae,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarIceLattae,txtIceLattae,E_IceLattae)).grid(row= 2, sticky=W)
ValeCoffee = Checkbutton(fCoffee, text="Vale Coffee \t",variable = VarValeCoffee,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarValeCoffee,txtValeCoffee,E_ValeCoffee)).grid(row= 3, sticky=W)
Cappuccino = Checkbutton(fCoffee, text="Cappuccino \t",variable = VarCappuccino,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarCappuccino,txtCappuccino,E_Cappuccino)).grid(row= 4, sticky=W)
AfricanCoffee = Checkbutton(fCoffee, text="African Coffee \t",variable = VarAfricanCoffee,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarAfricanCoffee,txtAfricanCoffee,E_AfricanCoffee)).grid(row= 5, sticky=W)
AmericanCoffee = Checkbutton(fCoffee, text="American Coffee \t",variable = VarAmericanCoffee,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarAmericanCoffee,txtAmericanCoffee,E_AmericanCoffee)).grid(row= 6, sticky=W)
IcedCappuccino = Checkbutton(fCoffee, text="Ice Cappuccino \t",variable = VarIcedCappuccino,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',18,'bold'),command=lambda:chkbutton_value(VarIcedCappuccino,txtIcedCappuccino,E_IcedCappuccino)).grid(row= 7, sticky=W)
...
txtLattae = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_Lattae,state = DISABLED)
txtLattae.grid(row=0,column =1)
txtEspresso = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_Espresso,state = DISABLED)
txtEspresso.grid(row=1,column =1)
txtIceLattae = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_IceLattae,state = DISABLED)
txtIceLattae.grid(row=2,column =1)
txtValeCoffee = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_ValeCoffee,state = DISABLED)
txtValeCoffee.grid(row=3,column =1)
txtCappuccino = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_Cappuccino,state = DISABLED)
txtCappuccino.grid(row=4,column =1)
txtAfricanCoffee = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_AfricanCoffee,state = DISABLED)
txtAfricanCoffee.grid(row=5,column =1)
txtAmericanCoffee = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_AmericanCoffee,state = DISABLED)
txtAmericanCoffee.grid(row=6,column =1)
txtIcedCappuccino = Entry(fCoffee,font=('TH Sarabun New',18,'bold'),bd=8,width=6,justify='left',textvariable=E_IcedCappuccino,state = DISABLED)
